...
const TextRollBtn = ({ text, href, orange = false }: { text: string; href: string; orange?: boolean }) => {
  return (
    <Link href={href} className={`group flex items-center gap-3 rounded-full pl-5 pr-2 py-2 transition-colors duration-500 ${orange ? 'bg-[#F26522] hover:bg-[#e05a1a]' : 'bg-gray-900'}`}>
      <div className="overflow-hidden h-[20px] relative">
        <div className="flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] group-hover:-translate-y-1/2">
          <span className="h-[20px] flex items-center text-white text-[13px] font-medium leading-none">{text}</span>
          <span className="h-[20px] flex items-center text-white text-[13px] font-medium leading-none">{text}</span>
        </div>
      </div>
      <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white rounded-full flex items-center justify-center shrink-0 transition-transform duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] group-hover:-rotate-45">
        <ArrowRight className={`w-3 h-3 sm:w-4 sm:h-4 ${orange ? 'text-[#F26522]' : 'text-gray-900'}`} strokeWidth={3} />
      </div>
    </Link>
  );
};
...
export default function App() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 font-sans selection:bg-gray-900 selection:text-white">
          ...
          <div className="bg-white rounded-full p-[5px] flex items-center justify-between shadow-sm pointer-events-auto">
            ...
            <div className="flex items-center gap-6">
              <Link href="/" className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-900 rounded-full flex items-center justify-center shrink-0">
                <span className="text-white text-[10px] sm:text-[11px] font-bold tracking-tight">ST</span>
              </Link>
              <div className="hidden md:flex items-center gap-6">
                <Link href="/register" className="text-[14px] text-gray-900 hover:text-gray-500 transition-colors duration-300">Browse Tutors</Link>
                <Link href="#how-it-works" className="text-[14px] text-gray-900 hover:text-gray-500 transition-colors duration-300">How it Works</Link>
                <Link href="/register" className="text-[14px] text-gray-900 hover:text-gray-500 transition-colors duration-300">Become a Tutor</Link>
                <Link href="/login" className="text-[14px] text-gray-900 hover:text-gray-500 transition-colors duration-300">Support</Link>
              </div>
            </div>

            {/* Nav Right (Desktop) */}
            <div className="hidden md:flex items-center gap-5">
              <span className="text-[13px] text-gray-600 hidden lg:block">Master any subject with top tutors</span>
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-end max-w-[1440px] w-full mx-auto px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20 pointer-events-none">
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5 pointer-events-auto">
            ...
            <div className="bg-white rounded-[4px] px-2 py-1.5 flex items-center gap-2.5 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] transition-shadow duration-300">
              <PartnerBadgeSVG />
              <span className="text-[13px] sm:text-[14px] font-medium text-gray-900">Verified Tutors Only</span>
              <span className="text-[10px] sm:text-[11px] bg-gray-900 text-white px-1.5 sm:px-2 py-0.5 rounded leading-none uppercase">Trusted</span>
            </div>
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            {['Register as Student', 'Register as Tutor', 'Login'].map((link) => (
              <Link key={link} href={`/${link.toLowerCase().includes('login') ? 'login' : 'register'}`} className="text-[28px] font-medium text-gray-900" onClick={() => setMobileMenuOpen(false)}>
                {link}
              </Link>
            ))}
          </div>
      ...
      <section id="how-it-works" className="bg-white pt-16 sm:pt-20 lg:pt-32 pb-12 sm:pb-16 lg:pb-24 overflow-hidden relative z-20">
        <div className="max-w-[1440px] mx-auto">
          {/* Badge Row */}
          <div className="px-5 sm:px-8 lg:px-12 flex items-center gap-3 mb-6 sm:mb-8">
            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gray-900 text-white text-[11px] sm:text-[12px] font-semibold flex items-center justify-center shrink-0">1</div>
            <div className="text-[12px] sm:text-[13px] font-medium border border-gray-200 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 text-gray-900">How the Marketplace Works</div>
          </div>
          ...
          <h2 className="px-5 sm:px-8 lg:px-12 text-[clamp(1.5rem,4vw,3.2rem)] font-medium leading-[1.12] tracking-[-0.02em] text-gray-900 mb-12 sm:mb-16 lg:mb-28 max-w-[1000px]">
            Seamlessly connect with vetted educators, <br className="hidden md:block"/> delivering results in digital classrooms and beyond.
          </h2>
            ...
            <div className="flex flex-col gap-8 lg:hidden">
              <div className="flex flex-col items-start gap-6">
                <p className="text-[15px] sm:text-[17px] leading-[1.6] font-medium text-gray-900">
                  Through strict KYC verification, secure Razorpay payments, and real-time chat, we help students realize their full potential safely.
                </p>
                <TextRollBtn text="Start Learning" href="/register" orange={true} />
              </div>
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
                <img src="https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260516_090123_74be96d4-9c1b-40cf-932a-96f4f4babed3.png&w=1280&q=85" alt="Student studying" className="w-full sm:w-[45%] aspect-[438/346] rounded-xl sm:rounded-2xl object-cover" />
                <img src="https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260516_090133_c157d30b-a99a-4477-bec1-a446149ec3f2.png&w=1280&q=85" alt="Tutor teaching" className="w-full sm:w-[55%] aspect-[900/600] rounded-xl sm:rounded-2xl object-cover" />
              </div>
            </div>

            {/* Desktop Layout */}
            <div className="hidden lg:grid grid-cols-[26%_1fr_48%] items-end gap-6 xl:gap-8">
              <img src="https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260516_090123_74be96d4-9c1b-40cf-932a-96f4f4babed3.png&w=1280&q=85" alt="Student studying" className="w-full aspect-[438/346] rounded-2xl object-cover self-end" />
              <div className="flex flex-col items-start gap-8 self-start justify-end h-full max-w-[320px] pb-8">
                <p className="text-[16px] xl:text-[18px] leading-[1.65] text-gray-900 font-medium">
                  Through strict KYC verification, <br/> secure Razorpay payments, <br/> and real-time chat, we help <br/> students realize their <br/> full educational potential.
                </p>
                <TextRollBtn text="Join as a Tutor" href="/register" orange={true} />
              </div>
              <img src="https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260516_090133_c157d30b-a99a-4477-bec1-a446149ec3f2.png&w=1280&q=85" alt="Tutor teaching" className="w-full aspect-[3/2] rounded-2xl object-cover self-end" />
            </div>
      ...
      <section className="bg-[#F5F5F5] pt-16 sm:pt-20 lg:pt-28 pb-16 sm:pb-20 lg:pb-28">
        <div className="max-w-[1440px] mx-auto">
          {/* Badge Row */}
          <div className="px-5 sm:px-8 lg:px-12 flex items-center gap-3 mb-6 sm:mb-8">
            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gray-900 text-white text-[11px] sm:text-[12px] font-semibold flex items-center justify-center shrink-0">2</div>
            <div className="text-[12px] sm:text-[13px] font-medium border border-gray-300 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 text-gray-900">Success Stories</div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7 px-5 sm:px-8 lg:px-12">
            ...
            <div className="flex flex-col">
              <div className="relative aspect-[329/246] rounded-2xl overflow-hidden bg-[#1a1d2e] group cursor-pointer">
                ...
                <Link href="/register" className="absolute bottom-4 left-4 h-9 w-9 bg-white rounded-full flex items-center overflow-hidden transition-all duration-300 ease-in-out group-hover:w-[148px]">
                  <div className="w-9 h-9 shrink-0 flex items-center justify-center z-10 bg-white rounded-full">
                    <LinkIcon className="w-3.5 h-3.5 text-gray-900 -rotate-45 transition-transform duration-300 ease-in-out group-hover:rotate-0" strokeWidth={2.5} />
                  </div>
              ...
              <div className="mt-4">
                <h3 className="text-[14px] sm:text-[15px] font-semibold text-gray-900">Prof. Sarah Jenkins</h3>
                <p className="text-[13px] sm:text-[14px] text-gray-600 mt-1 leading-relaxed">Winner of Tutor of the Year 2025 - Interactive Advanced Mathematics driving record exam scores.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <div className="relative aspect-square rounded-2xl overflow-hidden bg-[#6b6b6b] group cursor-pointer">
                ...
                <Link href="/register" className="absolute bottom-4 left-4 h-9 w-9 bg-gray-900 rounded-full flex items-center overflow-hidden transition-all duration-300 ease-in-out group-hover:w-[168px]">
                  <div className="w-9 h-9 shrink-0 flex items-center justify-center z-10 bg-gray-900 rounded-full">
                    <ArrowRight className="w-3.5 h-3.5 text-white -rotate-45 transition-transform duration-300 ease-in-out group-hover:rotate-0" strokeWidth={2.5} />
                  </div>
              ...
              <div className="mt-4">
                <h3 className="text-[14px] sm:text-[15px] font-semibold text-gray-900">Dr. David Chen</h3>
                <p className="text-[13px] sm:text-[14px] text-gray-600 mt-1 leading-relaxed">Transforming computer science fundamentals into an engaging learning experience.</p>
              </div>
            </div>
